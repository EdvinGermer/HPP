...
void merge_sort(int* list_to_sort, int N) {
  ...
  //if(N<25)
    //{
      //return bubble_sort(list_to_sort, N);
    //}
  ...
  // OPTIMIZATION 1 -> replace with one malloc
  //int* buffer = (int*)malloc(N*sizeof(int));
  //int* list1 = buffer;  // list 1 is first half of buffer
  //int* list2 = buffer+n1; // list 2 is second half of buffer

  // OPTIMIZATION 2 -> place on stack
  //int list1[n1];
  //int list2[n2];
