...
Array of 64 structs containing long ints

• Iterate over all elements and set values to zero  (with SetToZero function)
• Update every 8th element in the array with +3  500.000 times.
• Or
• Update only the first 8 elements in the array with +3  500.000 times.
